    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Formation>().HasData(
                ...
                new Formation { Id = 2, Libelle = "Formation 2", SalleId = 2, CoursId = 1});
            modelBuilder.Entity<Machine>().HasData(
                ...
                new Machine { Id = 2, Libelle = "Machine 2", Processeur = "Processeur 2", Capacite = "Capacite 2", Memoire = "Memoire 2", Taille_ecran = 10, SalleId = 2 });
